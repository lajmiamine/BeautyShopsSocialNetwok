...
public class FavorisAdapter extends RecyclerView.Adapter<FavorisAdapter.ViewHolder>{
    ...
    public FavorisAdapter(Context context, ArrayList<Stores> stores) {
        this.stores = stores;
    ...
    @Override
    public FavorisAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        if (!logo){
            imageViewImage.setImageBitmap(BitmapFactory.decodeResource(context.getResources(),R.drawable.fav));
            logo=true;
        }else {
            imageViewImage.setImageBitmap(BitmapFactory.decodeResource(context.getResources(),R.drawable.fav));
            logo=false;
