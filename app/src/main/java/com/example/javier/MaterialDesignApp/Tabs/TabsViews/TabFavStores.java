...
import com.example.javier.MaterialDesignApp.RecyclerView.RecyclerViewAdapters.FavorisAdapter;
...
public class TabFavStores extends Fragment {
    ...
    private void recyclerViewDesign(View view) {
        ...
        urlPost = "http://"+ Splashscreen.prefixe+".ngrok.io/beauty-shops/fav_by_user.php?user="+id;
    ...
    public class AsyncTaskNewsParseJson extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            recyclerViewAdapter = new FavorisAdapter(getActivity(), stores);
