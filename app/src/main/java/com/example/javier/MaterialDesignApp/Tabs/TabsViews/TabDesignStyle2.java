...
import com.example.javier.MaterialDesignApp.RecyclerView.RecyclerViewAdapters.ContainerAdapter;
...
public class TabDesignStyle2 extends Fragment {
    ...
    public class AsyncTaskNewsParseJson extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            recyclerViewAdapter = new ContainerAdapter(getActivity(), designs);
